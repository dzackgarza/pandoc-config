\begin{tikzpicture}
  ...
  \begin{scope}[transparency group]
	\fill[cyan] \convexpath{1,2}{8pt};
	\fill[cyan] \convexpath{2,4}{8pt};	
	\fill[cyan] \convexpath{2,5,6,7,8,9,10}{8pt};		
	\fill[cyan] \convexpath{10,11,12,13,14,15,16}{8pt};
	\fill[cyan] \convexpath{16,18}{8pt};	
	\fill[cyan] \convexpath{16,19}{8pt};		
  \end{scope}
	\end{pgfonlayer}
  \node at (5.5, 12) {\Huge $D_{16}*$};
\end{tikzpicture}
