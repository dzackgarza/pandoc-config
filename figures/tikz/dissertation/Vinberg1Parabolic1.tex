\begin{tikzpicture}
  ...
  \fill[cyan] \convexpath{1,3,2}{4pt};
	\fill[cyan] \convexpath{2,4}{4pt};	
	\fill[cyan] \convexpath{2,5,6,7,8,9}{4pt};		
	\fill[cyan] \convexpath{11,12,13,14,15,16}{4pt};
	\fill[cyan] \convexpath{16,17}{4pt};	
	\fill[cyan] \convexpath{16,19}{4pt};		
  \end{scope}
	\end{pgfonlayer}
  \node at (5, 12) {\Huge $E_8^2$};
\end{tikzpicture}
