...
%   sterk2 ias                        IAS^2 Gamma(X_0) of the F_{En,2} example
%   sterk2 kulikov                    its Kulikov central fibre X_0
%
% Keys:
...
%                               (default canonical)
%   ias involutions             sterk2 ias: the fixed lines of i_En and i_dP
...
\tikzset{pics/sterk2 ias/.style={/tikz/transform shape, code={%
  \tikzset{transform shape=false}%
...
\def\dzg@ias@selfint#1#2#3#4#5#6{%
  ...
  \fi}
\tikzset{pics/sterk2 kulikov/.style={/tikz/transform shape, code={%
  \tikzset{transform shape=false}%
  \foreach \n/\x/\y in \dzg@ias@sterkpoints \coordinate (-\n) at (\x,\y);
  \begin{scope}[on background layer]
