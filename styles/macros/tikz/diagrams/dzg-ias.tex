...
% The corners p_2 and p_19 carry charge 2: the I_2 singularity of [ABE22,
% Fig. 4] splits into two I_1 that collide with the corners [AEGS, §4.2,
% Fig. 12].
...
\tikzset{pics/symington 18 0 0/.style={/tikz/transform shape, code={%
  \tikzset{transform shape=false}%
  \dzg@ias@setell{1}{#1}%
  \dzg@ias@symington{2}{19}{0}{\dzg@ias@sides@b}{\dzg@ias@surg@b}{2/1, 19/1}%
