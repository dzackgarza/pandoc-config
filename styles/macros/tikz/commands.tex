...
% =============================================================================
% Diagram Layout & Coordinate Variables
% =============================================================================

\providecommand{\dynkinscale}{4.0}
\providecommand{\labeldistance}{8pt}

\providecommand{\colZero}{0}
\providecommand{\colOne}{2.5}
\providecommand{\colTwo}{5.5}
\providecommand{\colThree}{8.5}
\providecommand{\colFour}{11.5}
\providecommand{\lowerShift}{-5}

% Cusp diagram node label flags (0 = hidden, 1 = shown)
\providecommand{\cusponelabels}{0}
\providecommand{\cusptwolabels}{0}
\providecommand{\cuspthreelabels}{0}
\providecommand{\cuspfourlabels}{0}
\providecommand{\cuspfivelabels}{0}

% Hyperbolic geometry & poset parameters
\providecommand{\sectors}{18}
\providecommand{\s}{\the\numexpr\sectors-1\relax}
\providecommand{\total}{0}
