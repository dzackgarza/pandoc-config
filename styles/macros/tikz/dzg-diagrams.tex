...
\tikzset{
  pics/lattice polygon/.style n args={3}{/tikz/transform shape, code={\tikzset{transform shape=false}%
  ...
  pics/monomials/.style={/tikz/transform shape, code={\tikzset{transform shape=false}%
